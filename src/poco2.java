...
public class poco2 extends JFrame{
	JFrame frame;
	JPanel panel,panel1;
	...
	public poco2(String usern) {
		...
		ImageIcon pic1 = new ImageIcon (new ImageIcon("redmi.jpg").getImage().getScaledInstance(200, 250, Image.SCALE_DEFAULT));	
		sampic = new JLabel(pic1);
			sampic.setBounds(30,30,200,250);
			panel.add(sampic);
		desc = new JLabel("<html>Specs<br><br>Performance	Snapdragon 865<br><br>\r\n" + 
				"Storage	128 GB<br><br>\r\n" + 
				"Camera	108+13+2+2 MP<br><br>\r\n" + 
				"Battery	4780 mAh<br><br>\r\n" + 
			...
			public void itemStateChanged(ItemEvent e)
			{
				...
				{	
					...
					if(rad1.isSelected())
					{
						...
						String logg1 = ("SELECT * FROM products WHERE prod_id='225'");
			...
			public void itemStateChanged(ItemEvent e)
			{
				...
				{	
					...
					if(rad2.isSelected())
					{
						...
						{
						st = cn.createStatement();
						String logg1 = ("SELECT * FROM products WHERE prod_id='226'");
						rs = st.executeQuery(logg1);
						if(rs.next())
						{
							prodid = rs.getInt("prod_id");
