...
public class vivo1 extends JFrame{
	JFrame frame;
	JPanel panel,panel1;
	...
	public vivo1(String usern) {
		...
		ImageIcon pic1 = new ImageIcon (new ImageIcon("vivo1.jpg").getImage().getScaledInstance(200, 250, Image.SCALE_DEFAULT));	
		sampic = new JLabel(pic1);
			sampic.setBounds(30,30,200,250);
			panel.add(sampic);
		desc = new JLabel("<html>Specs<br><br>"
				+ "processor: Qualcomm Snapdragon 675<br><br>"
				+ "RAM: 8GB, 12GB<br><br>"
				+ "Battery Capacity: 4500 mAh<br><br>"
				+ "OS: Android 10<br><br>"
				+ "Storage: 128GB, 256GB<html>");
			...
			public void itemStateChanged(ItemEvent e)
			{
				...
				{	
					...
					if(rad1.isSelected())
					{
						...
						String logg1 = ("SELECT * FROM products WHERE prod_id='235'");
			...
			public void itemStateChanged(ItemEvent e)
			{
				...
				{	
					...
					if(rad2.isSelected())
					{
						...
						{
						st = cn.createStatement();
						String logg1 = ("SELECT * FROM products WHERE prod_id='236'");
						rs = st.executeQuery(logg1);
						if(rs.next())
						{
							prodid = rs.getInt("prod_id");
