...
public class ip extends JFrame{
	...
	JTextField qtytxt;
	JComboBox cmbColor;
	String cpname="iPhone 11 PRO max";
	...
	public ip(String usern) {
		...
		ImageIcon pic1 = new ImageIcon (new ImageIcon("ip1.jpg").getImage().getScaledInstance(200, 250, Image.SCALE_DEFAULT));	
		sampic = new JLabel(pic1);
			sampic.setBounds(30,30,200,250);
			panel.add(sampic);
		desc = new JLabel("<html>Specs<br><br>"
				+ "Screen (Resolution)\r\n" + 
				"6.5-inch Super Retina <br>XDR Display(2688 x 1242)<br>"
				+ "<br>CPU\r\n" + 
				"A13 Bionic<br>Storage\r\n" + 
				"256GB, 512GB<br><br>Rear Cameras\r\n" + 
				"12-MP wide (f/1.8), 12-MP<br> ultra wide (f/2.4), 12-MP telephoto (f/2.0)<br> <html>");
		desc.setBounds(250,10,260,250);
			panel.add(desc);
		variant = new JLabel("VARIANT");
			variant.setBounds(30,300,100,20);
			panel.add(variant);
		rad1 = new JRadioButton("256GB Storage + 8GB RAM");
			rad1.setBounds(30,330,200,20);
			panel.add(rad1);
		rad2 = new JRadioButton("512GB Storage + 8GB RAM");
		...
		cmbColor = new JComboBox(cmb);
			...
			panel.add(cmbColor);
		p1 = new JLabel("49000 Pesos");
			p1.setBounds(250,330,100,20);
			panel.add(p1);
		p2 = new JLabel("59000 Pesos");
			...
			public void itemStateChanged(ItemEvent e)
			{
				...
				{	
					...
					if(rad1.isSelected())
					{
						...
						descrip = "256GB Storage + 8GB RAM";
						pricedb = 49000;
						try
						{
						st = cn.createStatement();
						String logg1 = ("SELECT * FROM products WHERE prod_id='229'");
			...
			public void itemStateChanged(ItemEvent e)
			{
				...
				{	
					...
					if(rad2.isSelected())
					{
						...
						descrip = "512GB Storage + 8GB RAM";
						pricedb = 59000;
						try
						{
						st = cn.createStatement();
						String logg1 = ("SELECT * FROM products WHERE prod_id='230'");
						rs = st.executeQuery(logg1);
						if(rs.next())
						{
							prodid = rs.getInt("prod_id");
