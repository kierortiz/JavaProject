...
public class poco1 extends JFrame{
	JFrame frame;
	JPanel panel,panel1;
	...
	public poco1(String usern) {
		...
		ImageIcon pic1 = new ImageIcon (new ImageIcon("poco1.jpg").getImage().getScaledInstance(200, 250, Image.SCALE_DEFAULT));	
		sampic = new JLabel(pic1);
			sampic.setBounds(30,30,200,250);
			panel.add(sampic);
		desc = new JLabel("<html>Specs<br><br>Performance	Octa core<br><br>\r\n" + 
				"Storage	64 GB<br><br>\r\n" + 
				"Camera	12 MP<br><br>\r\n" + 
				"Battery	4000 mAh<br><br>\r\n" + 
				"Display	6.18\" (15.7 cm)<br><br>\r\n" + 
				"Ram	6 GB<html>");
		...
		cmbColor = new JComboBox(cmb);
			...
			panel.add(cmbColor);
		p1 = new JLabel("17000 Pesos");
			p1.setBounds(250,330,100,20);
			panel.add(p1);
		p2 = new JLabel("19000 Pesos");
			...
			public void itemStateChanged(ItemEvent e)
			{
				...
				{	
					...
					if(rad1.isSelected())
					{
						...
						String logg1 = ("SELECT * FROM products WHERE prod_id='223'");
			...
			public void itemStateChanged(ItemEvent e)
			{
				...
				{	
					...
					if(rad2.isSelected())
					{
						...
						{
						st = cn.createStatement();
						String logg1 = ("SELECT * FROM products WHERE prod_id='224'");
						rs = st.executeQuery(logg1);
						if(rs.next())
						{
							prodid = rs.getInt("prod_id");
