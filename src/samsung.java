...
public class samsung extends JFrame{
	...
	JComboBox cmbColor;
	//Container contr;
	String cpname="Samsung S20 Ultra";
	String cpbrand="Samsung";
	String descrip="";
	String colordb;
	...
	public samsung(String usern) {
		
		this.usern=usern;
		frame = new JFrame("SAMSUNG");
		panel = new JPanel();
	
		
		
		ImageIcon pic1 = new ImageIcon (new ImageIcon("sampic1.jpg").getImage().getScaledInstance(200, 250, Image.SCALE_DEFAULT));	
		sampic = new JLabel(pic1);
			sampic.setBounds(30,30,200,250);
			panel.add(sampic);
		desc = new JLabel("<html>* Pro-grade camera with 8k video<br> "
				+ "108MP high resolution"
				+ '\n' +"	and 100x Space Zoom<br><br>"
						+ "* Hyperfast 5G speed to keep you sharing and streaming "
				+"<br><br>* Samsung Knox security, an intelligent battery, powerful processor, and massive storage"
				+ "<br><br><br>AVAILABLE IN COLORS"
				+ "<br><br>White, Black, Space Grey<html>");
			desc.setBounds(250,10,260,250);
			panel.add(desc);
		variant = new JLabel("VARIANT");
			variant.setBounds(30,300,100,20);
			panel.add(variant);
		rad1 = new JRadioButton("64GB Storage + 8GB RAM");
			rad1.setBounds(30,330,200,20);
			panel.add(rad1);
		rad2 = new JRadioButton("128GB Storage + 12GB RAM");
		...
		cmbColor = new JComboBox(cmb);
			...
			panel.add(cmbColor);
		p1 = new JLabel("40000 Pesos");
			p1.setBounds(250,330,100,20);
			panel.add(p1);
		p2 = new JLabel("55000 Pesos");
			...
			public void itemStateChanged(ItemEvent e)
			{
				...
				{	
					...
					if(rad1.isSelected())
					{
						...
						descrip = "64GB Storage + 8GB RAM";
						pricedb = 40000;
						try
						{
						st = cn.createStatement();
						String logg1 = ("SELECT * FROM products WHERE prod_id='211'");
			...
			public void itemStateChanged(ItemEvent e)
			{
				...
				{	
					...
					if(rad2.isSelected())
					{
						...
						descrip = "128GB Storage + 12GB RAM";
						pricedb = 55000;
						try
						{
						st = cn.createStatement();
						String logg1 = ("SELECT * FROM products WHERE prod_id='212'");
						rs = st.executeQuery(logg1);
						if(rs.next())
						{
							prodid = rs.getInt("prod_id");
