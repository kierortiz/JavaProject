...
public class ip1 extends JFrame{
	JFrame frame;
	JPanel panel,panel1;
	...
	public ip1(String usern) {
		...
		ImageIcon pic1 = new ImageIcon (new ImageIcon("ip10.jpg").getImage().getScaledInstance(200, 250, Image.SCALE_DEFAULT));	
		sampic = new JLabel(pic1);
			sampic.setBounds(30,30,200,250);
			panel.add(sampic);
		desc = new JLabel("<html>Specs<br><br>OS: iOS 12\r\n" + 
				"Screen size: 5.8-inch\r\n" + 
				"Screen<br> <br>Resolution: 1125x2436\r\n" + 
				"<br>CPU: A11 Bionic\r\n" + 
				"<br>RAM: 3GB*\r\n" + 
				"<br>Storage: 64GB / 256GB<br>\r\n" + 
				"Battery: 2,716mAh<br>*\r\n" + 
		...
		variant = new JLabel("VARIANT");
			...
			panel.add(variant);
		rad1 = new JRadioButton("64GB Storage + 3GB RAM");
			rad1.setBounds(30,330,200,20);
			panel.add(rad1);
		rad2 = new JRadioButton("256GB Storage + 3GB RAM");
		...
		cmbColor = new JComboBox(cmb);
			...
			panel.add(cmbColor);
		p1 = new JLabel("39000 Pesos");
			p1.setBounds(250,330,100,20);
			panel.add(p1);
		p2 = new JLabel("51000 Pesos");
			...
			public void itemStateChanged(ItemEvent e)
			{
				...
				{	
					...
					if(rad1.isSelected())
					{
						...
						descrip = "64GB Storage + 3GB RAM";
						pricedb = 39000;
						try
						{
						st = cn.createStatement();
						String logg1 = ("SELECT * FROM products WHERE prod_id='231'");
			...
			public void itemStateChanged(ItemEvent e)
			{
				...
				{	
					...
					if(rad2.isSelected())
					{
						...
						descrip = "256GB Storage + 3GB RAM";
						pricedb = 51000;
						try
						{
						st = cn.createStatement();
						String logg1 = ("SELECT * FROM products WHERE prod_id='232'");
						rs = st.executeQuery(logg1);
						if(rs.next())
						{
							prodid = rs.getInt("prod_id");
