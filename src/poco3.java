...
public class poco3 extends JFrame{
	JFrame frame;
	JPanel panel,panel1;
	...
	JTextField qtytxt;
	JComboBox cmbColor;
	String cpname="Redmi Mi8";
	String cpbrand="Xiaomi";
	String descrip="";
	String colordb;
	...
	public poco3(String usern) {
		
		this.usern=usern;
		frame = new JFrame("Xiaomi");
		panel = new JPanel();
	
		
		
		ImageIcon pic1 = new ImageIcon (new ImageIcon("mi8.jpg").getImage().getScaledInstance(200, 250, Image.SCALE_DEFAULT));	
		sampic = new JLabel(pic1);
			sampic.setBounds(30,30,200,250);
			panel.add(sampic);
		desc = new JLabel("<html>Specs<br><br>Performance	Snapdragon 765<br><br>\r\n" + 
				"Storage	128/256 GB<br><br>\r\n" + 
				"Camera	108+13 MP<br><br>\r\n" + 
				"Battery	4080 mAh<br><br>\r\n" + 
				"Display	6.67\" (16.94 cm)<br><br>\r\n" + 
				"Ram	4/6 GB<html>");
		...
		variant = new JLabel("VARIANT");
			...
			panel.add(variant);
		rad1 = new JRadioButton("128GB Storage + 4GB RAM");
			rad1.setBounds(30,330,200,20);
			panel.add(rad1);
		rad2 = new JRadioButton("256GB Storage + 6GB RAM");
			...
			public void itemStateChanged(ItemEvent e)
			{
				...
				{	
					...
					if(rad1.isSelected())
					{
						...
						String logg1 = ("SELECT * FROM products WHERE prod_id='227'");
			...
			public void itemStateChanged(ItemEvent e)
			{
				...
				{	
					...
					if(rad2.isSelected())
					{
						...
						descrip = "256GB Storage + 6GB RAM";
						pricedb = 31000;
						try
						{
						st = cn.createStatement();
						String logg1 = ("SELECT * FROM products WHERE prod_id='228'");
						rs = st.executeQuery(logg1);
						if(rs.next())
						{
							prodid = rs.getInt("prod_id");
