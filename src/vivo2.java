...
public class vivo2 extends JFrame{
	JFrame frame;
	JPanel panel,panel1;
	...
	public vivo2(String usern) {
		...
		ImageIcon pic1 = new ImageIcon (new ImageIcon("vivo2.jpg").getImage().getScaledInstance(200, 250, Image.SCALE_DEFAULT));	
		sampic = new JLabel(pic1);
			sampic.setBounds(30,30,200,250);
			panel.add(sampic);
		desc = new JLabel("<html>Specs<br><br>"
				+ "Processor: Qualcomm Snapdragon 855 Plus<br><br>"
				+ "RAM: 8GB, 12GB"
				+ "<br><br>Storage: 128GB, 256GB<br><br>"
				+ "Battery Capacity: 4000mAh<br><br>"
				+ "Rear Camera: 48MP, + 13MP + 13MP<html>");
			...
			public void itemStateChanged(ItemEvent e)
			{
				...
				{	
					...
					if(rad1.isSelected())
					{
						...
						String logg1 = ("SELECT * FROM products WHERE prod_id='237'");
			...
			public void itemStateChanged(ItemEvent e)
			{
				...
				{	
					...
					if(rad2.isSelected())
					{
						...
						{
						st = cn.createStatement();
						String logg1 = ("SELECT * FROM products WHERE prod_id='238'");
						rs = st.executeQuery(logg1);
						if(rs.next())
						{
							prodid = rs.getInt("prod_id");
