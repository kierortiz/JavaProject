...
public class samsung2 extends JFrame{
	JFrame frame;
	JPanel panel,panel1;
	...
	public samsung2(String usern) {
		...
		ImageIcon pic1 = new ImageIcon (new ImageIcon("A30.jpg").getImage().getScaledInstance(200, 250, Image.SCALE_DEFAULT));	
		sampic = new JLabel(pic1);
			sampic.setBounds(30,30,200,250);
			panel.add(sampic);
		desc = new JLabel("<html>Processor<br> 2.3 GHz, 2.1 GHz. 1.5GHz Octa-Core<br><br>"
				+ "Display<br>Dynamic AMOLED  3040 x 1440 (Quad HD+)<br><br>"
				+ "Camera<br>12MP + 16MP  Optical Zoom at 2x, Digital Zoom up to 10x"
		...
		rad1 = new JRadioButton("64GB Storage + 4GB RAM");
			...
			panel.add(rad1);
		rad2 = new JRadioButton("128GB Storage + 6GB RAM");
		...
		cmbColor = new JComboBox(cmb);
			...
			panel.add(cmbColor);
		p1 = new JLabel("25000 Pesos");
			p1.setBounds(250,330,100,20);
			panel.add(p1);
		p2 = new JLabel("30000 Pesos");
			...
			public void itemStateChanged(ItemEvent e)
			{
				...
				{	
					...
					if(rad1.isSelected())
					{
						...
						descrip = "64GB Storage + 4GB RAM";
						pricedb = 25000;
						try
						{
						st = cn.createStatement();
						String logg1 = ("SELECT * FROM products WHERE prod_id='215'");
			...
			public void itemStateChanged(ItemEvent e)
			{
				...
				{	
					...
					if(rad2.isSelected())
					{
						...
						descrip = "128GB Storage + 6GB RAM";
						pricedb = 30000;
						try
						{
						st = cn.createStatement();
						String logg1 = ("SELECT * FROM products WHERE prod_id='216'");
						rs = st.executeQuery(logg1);
						if(rs.next())
						{
							prodid = rs.getInt("prod_id");
