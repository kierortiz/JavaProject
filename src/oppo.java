...
public class oppo extends JFrame{
	...
	JTextField qtytxt;
	JComboBox cmbColor;
	String cpname="Oppo Find x2 PRO";
	String cpbrand="Oppo";
	String descrip="";
	String colordb;
	...
	public oppo(String usern) {
		...
		ImageIcon pic1 = new ImageIcon (new ImageIcon("oppocp1.jpg").getImage().getScaledInstance(200, 250, Image.SCALE_DEFAULT));	
		sampic = new JLabel(pic1);
			sampic.setBounds(30,30,200,250);
			panel.add(sampic);
		desc = new JLabel("<html>Display<br>"
				+ "120Hz ultra-high refresh rate OLED curved screen QHD+<br><br>"
				+ "Dual-Mode 5g with 5.9Gbps max download speed and 4.1 Gbps mas upload speed"
				+ "<br><br>Processor<br>Snapdragon 865 the fastest processor on cellphones<html>");
			desc.setBounds(250,10,270,220);		
		...
		rad1 = new JRadioButton("128GB Storage + 8GB RAM");
			...
			panel.add(rad1);
		rad2 = new JRadioButton("512GB Storage + 12GB RAM");
			...
			public void itemStateChanged(ItemEvent e)
			{
				...
				{	
					...
					if(rad1.isSelected())
					{
						...
						String logg1 = ("SELECT * FROM products WHERE prod_id='217'");
			...
			public void itemStateChanged(ItemEvent e)
			{
				...
				{	
					...
					if(rad2.isSelected())
					{
						...
						descrip = "512GB Storage + 12GB RAM";
						pricedb = 59000;
						try
						{
						st = cn.createStatement();
						String logg1 = ("SELECT * FROM products WHERE prod_id='218'");
						rs = st.executeQuery(logg1);
						if(rs.next())
						{
							prodid = rs.getInt("prod_id");
