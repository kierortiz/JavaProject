...
public class oppo2 extends JFrame{
	JFrame frame;
	JPanel panel,panel1;
	...
	public oppo2(String usern) {
		...
		ImageIcon pic1 = new ImageIcon (new ImageIcon("oppocp3.jpg").getImage().getScaledInstance(200, 250, Image.SCALE_DEFAULT));	
		...
		cmbColor = new JComboBox(cmb);
			...
			panel.add(cmbColor);
		p1 = new JLabel("21000 Pesos");
			p1.setBounds(250,330,100,20);
			panel.add(p1);
		p2 = new JLabel("29000 Pesos");
			...
			public void itemStateChanged(ItemEvent e)
			{
				...
				{	
					...
					if(rad1.isSelected())
					{
						...
						String logg1 = ("SELECT * FROM products WHERE prod_id='221'");
			...
			public void itemStateChanged(ItemEvent e)
			{
				...
				{	
					...
					if(rad2.isSelected())
					{
						...
						{
						st = cn.createStatement();
						String logg1 = ("SELECT * FROM products WHERE prod_id='222'");
						rs = st.executeQuery(logg1);
						if(rs.next())
						{
							prodid = rs.getInt("prod_id");
